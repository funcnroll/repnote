      ...
      <div className="flex gap-6 flex-1">
        ...
        <div className="flex flex-col items-center gap-4 flex-1">
          ...
          <input
            ...
            className="bg-transparent text-white font-medium focus:outline-none focus:bg-backgroundColor focus:px-2 focus:py-1 focus:rounded transition-all duration-200 w-full text-center [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
            placeholder="0"
          />
        </div>
